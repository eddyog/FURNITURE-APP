...
const SingUp = ({ navigation }) => {
  ...
  const registerUser = async(values) =>{
    ...
    try {
      ...
      const iosUrl = `http://localhost:3000/api/register`;
      const androidUrl = `http://10.0.2.2:3000/api/register`;
            ...
            {({
              ...
              <View>
                <View style={styles.wrapper}>
                  ...
                  <View
                    style={styles.inputWrapper(
                      touched.username ? COLORS.blue : COLORS.offwhite
                    )}
                  >
                ...
                <View style={styles.wrapper}>
                  ...
                  <View
                    style={styles.inputWrapper(
                      touched.location ? COLORS.blue : COLORS.offwhite
                    )}
                  >
                    <Ionicons
